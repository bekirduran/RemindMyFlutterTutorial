...
import 'package:flutter_dersleri_devam/Utilities/stepper_code_helper.dart';
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          DropdownButton<String>(
            ...
            value: selectedCategory == null || !categories.contains(selectedCategory)?categories[0]:selectedCategory,
          )
        ],
      ),
    );
    ...
    return Container(child: Row(
      children: <Widget>[
        ...
        DropdownButton<String>(
          ...
          value: selectedSubCategory==null || !subCategorylist.contains(selectedSubCategory)?subCategorylist[0]:selectedSubCategory,
        )
      ],
    ),);
  }
